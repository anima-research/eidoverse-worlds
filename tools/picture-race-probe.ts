...
const POOL = [
  ...
  'computer_servers_rack_with_fans_on_back_single_column_preview.jpg',
...
async function joinAs(name: string) {
  ...
  await pg.waitForSelector('#micbtn, #mictoggle', { timeout: 30000 });   // #185 desktop badge or pre-#185 legacy badge
  return pg;
}
