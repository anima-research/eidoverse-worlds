...
// fileURLToPath, not .pathname: .pathname keeps %20s and the pre-drive slash,
// so any checkout under a path with a space handed the plugin a file that
// does not exist (PR #13's catch).
